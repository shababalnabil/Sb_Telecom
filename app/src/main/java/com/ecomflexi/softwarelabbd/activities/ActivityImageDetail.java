...
import com.ecomflexi.softwarelabbd.utilities.TouchImageView;
    ...
    public class saveImage extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                MediaScannerConnection.scanFile(ActivityImageDetail.this, as, null, new MediaScannerConnection.OnScanCompletedListener() {
